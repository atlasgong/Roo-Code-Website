...
import { InstallSection } from "@/components/homepage/install-section";
...
import { WhatsNewButton } from "@/components/homepage/whats-new-button";
                            ...
                            <div className="flex flex-col justify-center space-y-6 sm:space-y-8">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl">
                                        ...
                                        <AnimatedText className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">AI-Powered</AnimatedText>
                                    ...
                                    <p className="mt-4 max-w-md text-base text-muted-foreground sm:mt-6 sm:text-lg">
                                        Supercharge your editor with AI that <AnimatedText className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">understands your codebase</AnimatedText>, streamlines development, and helps you write, refactor, and debug with ease.
                                    </p>
                                </div>
                                <div className="flex flex-col space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
                                    ...
                                    <Button variant="outline" size="lg" className="w-full sm:w-auto">
                                        <a href="https://docs.roocode.com" target="_blank" className="flex w-full items-center justify-center">
                                            View Documentation
                                        </a>
                                    </Button>
                                </div>
