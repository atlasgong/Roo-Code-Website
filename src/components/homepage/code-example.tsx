            ...
            <div className="rounded-md bg-muted p-1.5 dark:bg-gray-900 sm:p-2">
                <div className="flex items-center justify-between border-b border-border px-2 py-1.5 sm:px-3 sm:py-2">
                    ...
                    <div className="flex space-x-1">
                        <button onClick={() => switchMode("code")} className={`rounded px-2 py-0.5 text-xs font-medium transition-colors sm:text-sm ${currentMode === "code" ? "bg-blue-500/20 text-blue-400" : "text-gray-400 hover:bg-gray-800"}`}>
                            Code
                        </button>
                        <button onClick={() => switchMode("architect")} className={`rounded px-2 py-0.5 text-xs font-medium transition-colors sm:text-sm ${currentMode === "architect" ? "bg-purple-500/20 text-purple-400" : "text-gray-400 hover:bg-gray-800"}`}>
                            Architect
                        </button>
                        <button onClick={() => switchMode("debug")} className={`rounded px-2 py-0.5 text-xs font-medium transition-colors sm:text-sm ${currentMode === "debug" ? "bg-green-500/20 text-green-400" : "text-gray-400 hover:bg-gray-800"}`}>
                            Debug
                        </button>
                    </div>
                </div>
