...
export function AnimatedBackground() {
    ...
    useEffect(() => {
        ...
        let gradientPoints = [
            { x: canvas.width * 0.2, y: canvas.height * 0.3, radius: canvas.width * 0.4, color: "rgba(0, 100, 255, 0.15)" },
            { x: canvas.width * 0.8, y: canvas.height * 0.7, radius: canvas.width * 0.5, color: "rgba(100, 0, 255, 0.1)" },
        ];
        ...
        function drawGrid() {
            if (!ctx) throw new Error("Context is null (not initialized?)");
