...
export const testimonials: Testimonial[] = [
    {
        ...
        quote: "RooCode has transformed our development workflow. The AI suggestions are incredibly accurate and have significantly improved our team's productivity.",
    },
    {
        id: 2,
        ...
        company: "InnovateAI",
        image: "/placeholder_pfp.png?height=80&width=80",
        quote: "After switching to RooCode, our development speed increased by 2x. The intelligent code completion and real-time collaboration features are game-changing.",
    },
    {
        id: 3,
        name: "Emily Watson",
        ...
        company: "DataFlow",
        image: "/placeholder_pfp.png?height=80&width=80",
        quote: "The AI-powered suggestions are mind-blowing. It's like having a senior developer looking over your shoulder, but better.",
    },
    {
        id: 4,
        name: "James Park",
        ...
        company: "CloudScale",
        image: "/placeholder_pfp.png?height=80&width=80",
        quote: "RooCode's ability to understand context and suggest relevant code is unprecedented. It's become an essential part of our tech stack.",
    },
];
        ...
        <section ref={containerRef} className="relative overflow-hidden border-t border-border py-32">
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mx-auto mb-24 max-w-3xl text-center">
                    ...
                    >
                        <h2 className="bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl">Empowering developers worldwide.</h2>
                        <p className="mt-6 text-lg text-muted-foreground">Join thousands of developers who are revolutionizing their workflow with AI-powered assistance.</p>
                    </motion.div>
                </div>
                        ...
                        {testimonials.map((testimonial, index) => (
                            <motion.div key={testimonial.id} variants={itemVariants} className={`group relative ${index % 2 === 0 ? "md:translate-y-4" : "md:translate-y-12"}`}>
                                ...
                                <div className="relative rounded-2xl border border-border/50 bg-background/30 backdrop-blur-xl transition-all duration-500 ease-out group-hover:border-border group-hover:bg-background/40">
                                    ...
                                    <div className="p-8">
                                        <div className="mb-6">
                                            <svg className="h-8 w-8 text-blue-500/20" fill="currentColor" viewBox="0 0 32 32">
                                                <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                                            </svg>
                                        </div>

                                        <p className="relative mb-6 text-lg leading-relaxed text-muted-foreground">{testimonial.quote}</p>
