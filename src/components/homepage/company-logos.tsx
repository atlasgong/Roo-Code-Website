            ...
            <div className="mx-auto grid max-w-5xl grid-cols-2 gap-8 py-8 md:grid-cols-3 lg:grid-cols-6">
                {logos.map((company, index) => (
                    ...
                    >
                        ...
                        <img src={company.logo || "/placeholder.svg"} alt={company.name} className="h-10 w-auto opacity-70 grayscale transition-all duration-300 hover:opacity-100 hover:grayscale-0" />
                    </motion.div>
                ))}
            </div>
        </div>
