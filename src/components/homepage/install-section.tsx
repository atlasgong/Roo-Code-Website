...
export function InstallSection({ downloads }: InstallSectionProps) {
    ...
    return (
        <section className="relative overflow-hidden border-t border-border py-16 sm:py-24 lg:py-32">
            <motion.div className="absolute inset-x-0 top-1/2 -translate-y-1/2" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={backgroundVariants}>
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="text-center text-xl font-semibold uppercase tracking-wider text-muted-foreground sm:text-2xl">Install Roo Code</h2>
                    <p className="mt-4 text-center text-base text-muted-foreground sm:mt-6 sm:text-lg">Get started with Roo Code in minutes. Install directly from VS Code or use the command line.</p>
                    <div className="mt-10 flex flex-col items-center justify-center gap-6">
                        <Link href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline" target="_blank" className="group relative inline-flex w-full items-center justify-center gap-2 rounded-xl border border-border/50 bg-background/30 px-4 py-3 text-base backdrop-blur-xl transition-all duration-300 hover:border-border hover:bg-background/40 sm:w-auto sm:gap-3 sm:px-6 sm:py-4 sm:text-lg md:text-2xl">
                            ...
                            <div className="relative flex items-center gap-2 sm:gap-3">
                                ...
                                <span className="flex flex-wrap items-center gap-1 sm:gap-2 md:gap-3">
                                    ...
                                    {downloads !== null && (
                                        <>
                                            <span className="hidden font-black text-muted-foreground sm:inline">&middot;</span>
                            ...
                            <div className="relative overflow-hidden rounded-xl border border-border/50 bg-background/30 backdrop-blur-xl transition-all duration-500 ease-out group-hover:border-border group-hover:bg-background/40">
                                ...
                                <div className="overflow-x-auto">
                                    <pre className="p-3 sm:p-4">
                                        <code className="whitespace-pre-wrap break-all text-sm text-foreground/90 sm:break-normal">code --install-extension RooVeterinaryInc.roo-cline</code>
                                    </pre>
                                </div>
                            </div>
                        </div>
